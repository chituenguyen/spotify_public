...
const Login = () => {
  ...
  return (
    <div>
      ...
      {/* Continue */}
      <div className="flex flex-col items-center justify-center gap-4 pt-9">
      {message ==="Incorrect username or password" ? <p className="w-[450px] bg-red-600 text-center py-3 text-white">Incorrect username or password</p>:""}
        <p className="text-sm font-bold">To continue, login in to Spotify.</p>
        <button className="flex items-center justify-center w-[450px] bg-[#3b5998] rounded-full py-3 text-white font-semibold gap-3 ">
          <FaFacebookSquare />
          <h2 className="tracking-wider text-sm">CONTINUE WITH FACEBOOK</h2>
        </button>

        <button className="flex items-center justify-center w-[450px] bg-[#000000E6] rounded-full py-3 text-white font-semibold gap-3">
          <BsApple color="white" />
          <h2 className="tracking-wider text-sm">CONTINUE WITH APPLE</h2>
        </button>

        <button className="flex items-center justify-center w-[450px] bg-[#fff] rounded-full py-3 text-[#6a6a6a] font-semibold gap-3 border-[1px] border-[#878787]">
          <FcGoogle />
          <h2 className="tracking-wider text-sm">CONTINUE WITH GOOGLE</h2>
        </button>

        <button className="flex items-center justify-center w-[450px] bg-[#fff] rounded-full py-3 text-[#6a6a6a] font-semibold gap-3 border-[1px] border-[#878787]">
          <h2 className="tracking-wider text-sm">CONTINUE WITH PHONE NUMBER</h2>
        </button>
      </div>
      ...
      <div className="flex flex-col border-[1px] border-x-0  border-y-[#909090] mx-auto w-[450px] pt-6 mt-5 pb-4">
        ...
        <input
          type="text"
          className="border-[1px] border-[#b5b5b5e6]  bg-[#e8f0fe] h-[45px] py-auto px-3 mt-2 hover:border-black"
        ...
        <p className="text-sm font-medium mt-3">Forgot your password ?</p>
        <div className="flex">
          <div className="flex grow items-center gap-2">
            <input type="checkbox" className="accent-[#1ed760]" />
            <p>Remerber me</p>
          </div>
          <button
            className="w-[127px] h-[45px] bg-[#1ed760] rounded-full uppercase tracking-wider font-semibold"
            onClick={() => handleLogin()}
          >
            Log in
          </button>
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <button className="flex items-center justify-center w-[450px] bg-[#fff] rounded-full py-3 text-black font-semibold border-[1px] border-[#b5b5b5e6] hover:border-black">
          SIGN UP FOR SPOTIFY
        </button>
      </div>
    </div>
